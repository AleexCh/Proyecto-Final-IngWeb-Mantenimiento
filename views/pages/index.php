...
<div class="container container-fluid Controlbase align-self-center" >
        ...
        <div class="col col-lg-6 col-sm-12 align-self-center justify-content-center columnaContenido" >
            <div class = "sPrincipal"><h1 class="tituloPrincipal  ">Bienvenido al Mundial de qatar 2022</h1></div>
            <div class = "sPrincipal textoMedio"><p class="textoSecundario ">Las mejores noticias sobre el Mundial de fútbol sólo aquí</p></div>
        </div>
